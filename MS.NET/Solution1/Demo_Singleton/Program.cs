...
using static Demo_Singleton.DataBaseFactory;
...
namespace Demo_Singleton
{
    internal class Program
    {
        static void Main(string[] args)
        {
            while (true)
            {
                Console.WriteLine("Enter Your DataBase Choice: 1. SqlServer, 2. MySql Server, 3. Oracle Server");
    ...
    public class DataBaseFactory
    {
        ...
        public class Logger
        {
            ...
            Console.WriteLine("Logger Object is created (1st Time)");
